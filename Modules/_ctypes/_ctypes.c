...
*/
    ...
    _Py_SET_TYPE(&Struct_Type, &PyCStructType_Type);
    ...
    _Py_SET_TYPE(&Union_Type, &UnionType_Type);
    ...
    _Py_SET_TYPE(&PyCPointer_Type, &PyCPointerType_Type);
    ...
    _Py_SET_TYPE(&PyCArray_Type, &PyCArrayType_Type);
    ...
    _Py_SET_TYPE(&Simple_Type, &PyCSimpleType_Type);
    ...
    _Py_SET_TYPE(&PyCFuncPtr_Type, &PyCFuncPtrType_Type);
